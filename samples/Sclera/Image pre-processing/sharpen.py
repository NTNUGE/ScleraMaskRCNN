...
read_path = glob.glob(r"C:\Users\goura\OneDrive\Desktop\SSBCDATASET\NIR\train\*")
...
for get_image in read_path:
   ...
   ret, thresh3 = cv2.threshold(im, 60, 160, cv2.THRESH_TRUNC)
   image_sharp = cv2.filter2D(thresh3, -4, kernel)

   #ret, thresh3 = cv2.threshold(image_sharp, 120, 255, cv2.THRESH_TRUNC)
   print(get_data)
   #rgb_im = im1.convert('RGB')
   cv2.imwrite(r"C:\Users\goura\OneDrive\Desktop\SSBCDATASET\NIR\SegmentationClass\threshold_dataset\\" + get_data + '.jpg', thresh3)
