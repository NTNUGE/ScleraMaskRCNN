...
read_path = glob.glob(r"/home/user1/Desktop/kiran-sandbox/Mask_RCNN/samples/Sclera/NIR-2021/v1/CASIA-Iris-Africa/Iris_pupil/SegmentationClass/*")
...
for get_image in read_path: 
	...
	# Convert to grayscale. 
		...
		detected_circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, 1, 90, param1 = 100, param2 = 10, minRadius = 0, maxRadius = 100) 
