...
weights_path = "/home/user1/Desktop/kiran-sandbox/Mask_RCNN/samples/Sclera/weights/NIR/submission_v1/CASIA-Iris-Mobile-V1.0/pupil/mask_rcnn_sclera_0120.h5" #model.find_last()

result_dir = sys.argv[1]
if not os.path.exists(result_dir):
    os.mkdir(result_dir)

mask_result_dir = result_dir + "/SegmentationClass/"
...
image_id = 0
for img in glob.glob("/home/user1/Desktop/kiran-sandbox/Mask_RCNN/samples/Sclera/dataset/NIR/nir_submission/testing_nir/CASIA-Iris-Asia/CASIA-distance/test/image_v1/*"):
	#print(img.split('/')[-1])
	...
	if mask_image.size != 0:
		try:
			...
			logfile.write("%s\n" % img)
			new_img = Image.new('RGB',(1088,640))
			new_img.save(mask_file_name, "PNG", optimize=True)
			#skimage.io.imsave(splash_file_name, image)
			continue
	else:
		print("Failed val image :: " + img)
		logfile.write("%s\n" % img)
